package com.simon.common.bean.util;
...
public class PojoClassInfo {
     ...
     *            - 类.
     */
    private <T extends Serializable> PojoClassInfo(Class<T> clazz) {
     ...
     */
    public static <T extends Serializable> PojoClassInfo getInstance(Class<T> clazz) {
